...
DIALECT_WORD_MAP = {
    "iraq": {"كثير": "هواية", "ماذا": "شنو", "أين": "وين", "الآن": "هسة", "قال": "كال", "يوجد": "أكو", "لا يوجد": "ماكو"},
    "egypt": {"كثير": "أوي", "ماذا": "إيه", "الآن": "دلوقتي", "هذا": "ده", "هذه": "دي", "ليس": "مش", "فقط": "بس"},
    "syria": {"كثير": "كتير", "ماذا": "شو", "الآن": "هلق", "جيد": "منيح", "هكذا": "هيك", "شيء": "شي"},
    "gulf": {"كثير": "وايد", "جيد": "زين", "الآن": "الحين", "ماذا": "وش", "هذا": "هاذا", "نعم": "إيه"},
    "msa": {},
    "english": {},
    "british": {},
}
